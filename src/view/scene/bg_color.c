...
void InitBgColor(App *app) {
  ...
  int inputTextTop = 40;
  int padd = 470;
  InitSubmitButton(&app->ui.bgColorPurple,
                   (Rectangle){GetScreenWidth() - inputTextWidth - padd,
                               inputTextTop, 24, 24},
                   "1", (Color){247, 222, 246, 255}, BLACK, 12);
  InitSubmitButton(&app->ui.bgColorLavender,
                   (Rectangle){GetScreenWidth() - inputTextWidth - padd + 26,
                               inputTextTop, 24, 24},
                   "2", (Color){223, 227, 247, 255}, BLACK, 12);
  InitSubmitButton(&app->ui.bgColorRose,
                   (Rectangle){GetScreenWidth() - inputTextWidth - padd + 52,
                               inputTextTop, 24, 24},
                   "3", (Color){247, 228, 223, 255}, BLACK, 12);
  InitSubmitButton(&app->ui.bgColorBeige,
                   (Rectangle){GetScreenWidth() - inputTextWidth - padd + 78,
                               inputTextTop, 24, 24},
                   "4", (Color){237, 247, 223, 255}, BLACK, 12);
  InitSubmitButton(&app->ui.bgColorWhite,
                   (Rectangle){GetScreenWidth() - inputTextWidth - padd + 104,
                               inputTextTop, 24, 24},
                   "5", RAYWHITE, BLACK, 12);
}