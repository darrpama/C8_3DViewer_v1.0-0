...
void drawWireColors(App *app) {
  ...
  int top = 675;
  int left = GetScreenWidth() - 20 - width;
  DrawText("Wire colors", left + TRANSFORM_PANEL_WIDTH - 120, top, 14, Fade(BLACK, 0.5f));
...
void initWireColors(App *app) {
  ...
  InitSubmitButton(&app->ui.wireColorRed, (Rectangle){ GetScreenWidth() - inputTextWidth - 95, inputTextTop, 24, 24 }, " ", ColorAlpha(RED, 0.7), BLACK, 12);
  InitSubmitButton(&app->ui.wireColorGreen, (Rectangle){ GetScreenWidth() - inputTextWidth - 95 + 26, inputTextTop, 24, 24 }, " ", ColorAlpha(GREEN, 0.7), BLACK, 12);
  InitSubmitButton(&app->ui.wireColorBlue, (Rectangle){ GetScreenWidth() - inputTextWidth - 95 + 52, inputTextTop, 24, 24 }, " ", ColorAlpha(BLUE, 0.7), BLACK, 12);
  InitSubmitButton(&app->ui.wireColorViolet, (Rectangle){ GetScreenWidth() - inputTextWidth - 95 + 78, inputTextTop, 24, 24 }, " ", ColorAlpha(VIOLET, 0.7), BLACK, 12);
  InitSubmitButton(&app->ui.wireColorGray, (Rectangle){ GetScreenWidth() - inputTextWidth - 95 + 104, inputTextTop, 24, 24 }, " ", ColorAlpha(GRAY, 0.7), BLACK, 12);
  InitSubmitButton(&app->ui.wireColorBlack, (Rectangle){ GetScreenWidth() - inputTextWidth - 95 + 130, inputTextTop, 24, 24 }, " ", ColorAlpha(BLACK, 0.7), BLACK, 12);
}

void initWiresViewButtons(App *app) {
  int top = 600;
  InitSubmitButton(&app->ui.noWireViewButton, (Rectangle){GetScreenWidth() - 185, top, 140, 20}, "No", LIGHTGRAY, BLACK, 12);
  InitSubmitButton(&app->ui.solidViewButton, (Rectangle){GetScreenWidth() - 185, top + 25, 140, 20}, "Solid", LIGHTGRAY, BLACK, 12);
  InitSubmitButton(&app->ui.dashedViewButton, (Rectangle){GetScreenWidth() - 185, top + 50, 140, 20}, "Dashed", LIGHTGRAY, BLACK, 12);
}
