...
void savePicHandler(App *app) {
  ...
  // if (out_data != NULL) {
  //   // stbi_write_jpg("aboba.jpg", out_w, out_h, 3, out_data, out_w *
  //   sizeof(int));
...
void DrawSavePicButton(App *app) { DrawIconButton(&app->ui.saveGifBtn); }
...
void InitSavePicButton(App *app) {
  ...
  InitIconButton(icon, &app->ui.saveGifBtn,
