...
RLAPI void DrawModelDots(Model model, Vector3 position, float scale, Color tint);
RLAPI void DrawModelDotsEx(Model model, Vector3 position, Vector3 rotationAxis, float rotationAngle, Vector3 scale, Color tint);
